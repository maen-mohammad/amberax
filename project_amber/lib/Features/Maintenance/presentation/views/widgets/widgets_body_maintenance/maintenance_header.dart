    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              GoRouter.of(context).push(AppRouter.kNotficaionsMaintenanceViewBody);
            },
            child: Stack(
