...
class ListSubscribersCollectionView extends StatelessWidget {
  const ListSubscribersCollectionView({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (int i = 0; i < 10; i++)
                    InkWell(
                      onTap: () {
                        GoRouter.of(context).push(AppRouter.kInvoicesSubscriberView);
                      },
                      child: Container(
