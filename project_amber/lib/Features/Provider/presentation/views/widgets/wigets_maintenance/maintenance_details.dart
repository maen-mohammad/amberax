...
class MaintenanceDetails extends StatelessWidget {
                  ...
                  child: Form(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          fieldsDetails(
                              title: "أسم عامل الصيانة", content: nameSubscriber),
                          SizedBox(
                            height: 8,
                          ),
                          fieldsDetails(
                              title: "عنوان عامل الصيانة ",
                              content: adressSubscriber),
                          SizedBox(
                            height: 8,
                          ),
                          fieldsDetails(
                              title: "رقم التعريفي لعامل الصيانة",
                              content: numberSubscriber),
                          SizedBox(
                            height: 8,
                          ),
                          fieldsDetails(
                              title: "هاتف عامل الصيانة", content: phoneSubscriber),
                          SizedBox(
                            height: 8,
                          ),
                          Container(
                            alignment: Alignment.topRight,
                            child: Text("صورة هوية عامل الصيانة",
                                style: TextStyle(
                                  fontSize: 20,
                          ...
                          Container(
                            ...
                            child: DefaultButton(
                              ...
                              onTap: () {
                                GoRouter.of(context)
                                    .push(AppRouter.kMaintenanceRequest);
                              },
                            ),
                          ),
                          SizedBox(
